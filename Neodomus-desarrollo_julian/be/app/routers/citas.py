...
from app.services.notificaciones import crear_notificacion, notificar_cita_asignada_tecnico, notificar_recordatorio_cita
...
def listar_productos_cita(
    ...
    if role not in ("admin", "administrador"):
        ...
        if not tecnico or cita.id_tecnico != tecnico.id_tecnico:
