        ...
        <form onSubmit={handleSubmit} className="register-form">
          ...
          <div className="form-grid">
            ...
            <div className="input-group-block">
              ...
              <input name="documento" placeholder="Ingresa tu número de documento" value={formData.documento} autoComplete="off" inputMode="numeric" pattern="[0-9]*" onChange={handleChange} required disabled={loading} />
            </div>
            ...
            <div className="input-group-block">
              ...
              <input name="telefono" placeholder="Ingresa tu número telefónico" value={formData.telefono} autoComplete="tel" inputMode="numeric" pattern="[0-9]*" onChange={handleChange} required disabled={loading} />
            </div>
