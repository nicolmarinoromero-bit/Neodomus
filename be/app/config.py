...
class Settings(BaseSettings):
    ...
    # EMAIL_PROVIDER="gmail_api": Gmail API con OAuth 2.0 (no requiere
    # contraseña de aplicación; requiere GOOGLE_CLIENT_ID, GOOGLE_CLIENT_SECRET
    # y GOOGLE_REFRESH_TOKEN obtenidos con scripts/gmail_oauth.py).
