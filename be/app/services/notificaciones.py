...
def crear_notificacion(db, id_usuario: int, tipo: str, titulo: str, mensaje: str) -> None:
    """Crea una notificación de plataforma para un usuario (fire-and-forget).
    ...
    try:
        ...
        db.rollback()
        print(f"Error creando notificación de plataforma para usuario {id_usuario}: {e}")
